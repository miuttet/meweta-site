var GIGS = [
  ...
  },
  {
    ...
    venue: "BEFOR",
    artists: [
      { role: "B1", names: "PERGO / Alice Yuki / manato / Usk°" },
  ...
  },
  {
    ...
    artists: [
      ...
      { role: "DJ", names: "ansui / icopalmer / 津田 / meweta" }
    ]
  },
  {
    date: "2026-01-28",
    event: "ADDIFY vol.4",
    venue: "中野HeavySick Zero",
    time: "OPEN 19:00 / CLOSE 23:00",
    artists: [
      { role: "DJ", names: "meweta / CUE KITAZAWA / M0bca5 B2B Realgal Alcoólico / Madeinl B2B ShoN" },
      { role: "VJ", names: "嘘の名前" }
    ]
  },
  {
    date: "2026-01-24",
    event: "ONESIXTY",
    venue: "Neo Shinjuku Atsushi",
    time: "OPEN 24:00 / CLOSE 06:00",
    artists: [
      { role: "DJ", names: "OYUBI / FETUS / MEWETA / VOX / SAZABLIZRY / SZO" }
    ]
  },
  {
    date: "2026-01-24",
  ...
  {
    date: "2026-01-24",
    event: "agul 1st Album \"Forecast\" Release Party",
    venue: "恵比寿BATICA",
    time: "OPEN 16:30 / CLOSE 22:00",
    artists: [
  ...
  },
  {
    ...
    time: "OPEN 18:00",
    artists: [
      { role: "live", names: "8bit Gang untitled01 / Chapa the DRO initiation / FOREVER THE WORLD" },
      { role: "DJ", names: "0xygen / meweta / S3R4PH / NOWBU / jingan / ullpo" }
    ]
  },
  {
    date: "2026-01-17",
    ...
    time: "OPEN 21:00",
    artists: [
      { role: "DJ", names: "pawpaw / kanachanya / omokage / joseshimo / meweta / attkh~~~i" }
    ]
  },
  {
    date: "2026-01-16",
  ...
  },
  {
    ...
    time: "OPEN 22:00",
    artists: [
      { role: "live", names: "倫瑠 / iga / in-mark / Hibicure" },
      { role: "DJ", names: "津田 / che2 / hasciii / Imkaka / meweta" }
    ]
  },
  {
    date: "2025-11-11",
    ...
    time: "OPEN 18:30",
    artists: [
      { role: "live", names: "Metome / otaco / Telematic Visions" },
      { role: "DJ", names: "Imkaka / サトウツバサ / 増田優作 / meweta" }
    ]
  },
  {
    date: "2025-11-05",
  ...
  },
  {
    ...
    event: "第四の道:petit 05",
    venue: "新宿SPACE",
    time: "OPEN 21:00 / CLOSE 05:00",
    artists: [
      { role: "live", names: "サイケアウツG / nerdcamp.ramcore" },
      { role: "DJ", names: "超越 / Aki Dolanikov / glico / meweta / SPIRIA / NordOst" }
    ]
  },
  {
    date: "2025-10-24",
  ...
  {
    date: "2025-10-22",
    event: "K/A/T/O MASSACRE 550th anniversary",
    venue: "幡ヶ谷FORESTLIMIT",
  ...
  },
  {
    ...
    time: "OPEN 23:30",
    artists: [
      { role: "live", names: "nomβa (nano odorine × DjuBumba) / 百年の孤独 (One Boiling Point × toulavi × loli主語)" },
      { role: "DJ", names: "Hue Ray / iichiro taya / moge! / shki / meweta" }
    ]
  },
  {
    date: "2025-09-27",
